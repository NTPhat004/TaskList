        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelatedGroupId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    RelatedTaskId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    RelatedSubTaskId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupInvitation_Users_InviteeId",
                        column: x => x.InviteeId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GroupInvitation_Users_InviterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupInvitation_InviteeId",
                table: "GroupInvitation",
                column: "InviteeId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupInvitation_InviterId",
                table: "GroupInvitation",
                column: "InviterId");
